...
namespace PROG7311_Task_2.Controllers
{
    public class AdminController : Controller
    {
        ...
        {
            List<Tbl_Product> allcategories = _unitOfWork.GetRepositoryInstance<Tbl_Product>().GetAllRecordsIQueryable().Where(i => i.IsDelete == false).ToList();
            return View(allcategories);
        }
        ...
        {
            List<Tbl_Orders> allcategories = _unitOfWork.GetRepositoryInstance<Tbl_Orders>().GetAllRecordsIQueryable().ToList();
            return View(allcategories);
